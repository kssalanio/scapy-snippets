...
def packet_with_seq_n(iface, src_ip, src_port, dst_ip, dst_port, seq_num, pcap_file):
#    packet = IP(dst="192.168.100.123", src="192.168.100.144")/TCP(sport=333, dport=222, seq=112344)/"Sequence number 112344"
    packet = IP(dst=dst_ip, src=src_ip)/TCP(sport=src_port, dport=dst_port, seq=seq_num)/"PAYLOAD HERE"
...
if __name__ == "__main__":
    ...
    packet_with_seq_n(args.iface, args.src_ip, args.src_port, args.dst_ip, args.dst_port, args.seq_num, args.pcap_file)
